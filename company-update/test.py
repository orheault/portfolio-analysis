...
def test_retrieve_candle_invest():
    import investpy
    search_result = investpy.search_quotes(text='su', products=['stocks'], countries=['Canada'], n_results=1)
    historical_data = search_result.retrieve_historical_data(from_date='01/01/2000', to_date='18/07/2021')
